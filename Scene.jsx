...
Command: npx gltfjsx@6.2.18 .\public\models\scene.glb -K -k 
*/
...
export function Model(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Empty" position={[-0.188, 0.306, -0.673]} rotation={[-Math.PI, 0.53, -Math.PI]}>
          <group name="Armature">
        ...
        <group name="keyboard" position={[-0.104, 0.981, -1.316]} rotation={[0, -0.165, 0]} scale={[0.82, 1, 0.88]}>
        ...
        <mesh name="Comp_Mouse" geometry={nodes.Comp_Mouse.geometry} material={materials['lambert3SG.003']} position={[-0.22, 0, 0.01]} />
        ...
        <group name="Chair" position={[-0.188, 0, -0.708]} rotation={[0, -0.376, 0]}>
